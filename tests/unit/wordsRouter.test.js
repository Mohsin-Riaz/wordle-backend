...
const app = require('../../index'); // Import the app from your root index.js
...
describe('API Routes', () => {
    ...
    it('GET /api/checkword should return correct word data', async () => {
        const response = await request(app).get('/api/checkword?word=turtle');
    ...
    it('GET /api/checkword should not return word details for non-existant word parameter', async () => {
        const response = await request(app).get('/api/checkword');
    ...
    it('GET /api/checkword?word=NOTAWORD should not return word details for non-existant word', async () => {
        const response = await request(app).get('/api/checkword?word=NOTAWORD');
